...
## 10. Prototype Implementation Mapping (2026-04-12)

This section records how the first implementation maps this design system to the current React + Vite prototype.

### Implemented now
- Core palette: black and near-black surfaces with white/gray typography and Ferrari Red CTA.
- Geometry: near-zero radius (`2px`) used on cards, inputs, and buttons.
- Information hierarchy: status strip, control sections, and chart region.
- Motion and density: simple realtime updates through websocket; no decorative micro-motion yet.

### Deferred to next iteration
- Ferrari-like editorial carousel and full storytelling sections.
- Rich image-led hero treatments and art-directed photography.
